...
export const normalizedHash = (value: string) =>
...
export const extractImageFromRssItem = (item: Record<string, unknown>) => {
  ...
  const mediaThumb = (item['media:thumbnail' as keyof typeof item] as any) || (item.mediaThumbnail as any);
