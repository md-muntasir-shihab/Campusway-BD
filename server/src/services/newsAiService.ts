...
export const generateStrictExtractiveDraft = (input: AiDraftInput): AiDraftOutput => {
  ...
  const category =
    uniqueTags.find((tag) => ['admission', 'scholarship', 'education', 'university', 'exam'].includes(tag)) ||
    'education';
