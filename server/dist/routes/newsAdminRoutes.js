...
import { approvePublishAdminNews, createAdminNews, createRssSource, deleteAdminNews, deleteRssSource, duplicateMerge, duplicatePublishAnyway, exportNews, fetchRssNow, getAdminAuditLogs, getAdminNewsById, getAdminNewsList, getAdminNewsSettings, listRssSources, moveNewsToDraft, putNewsSettings, rejectAdminNews, scheduleAdminNews, testRssSource, updateAdminNews, updateRssSource, uploadMedia } from '../controllers/newsAdminController.js';
