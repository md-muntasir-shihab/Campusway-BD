...
const resolveCover = (item, defaultBanner) => {
...
export const getPublicNewsList = async (req, res) => {
    ...
    const mapped = items.map((item) => {
        ...
        return {
            ...item,
            coverImageUrl: resolveCover(item, settings.defaultBannerUrl || settings.defaultThumbUrl || ''),
...
export const getPublicNewsBySlug = async (req, res) => {
    ...
    return sendSuccess(res, {
        ...
        related: related.map((entry) => ({
            ...entry,
            coverImageUrl: resolveCover(entry, settings.defaultBannerUrl || settings.defaultThumbUrl || '')
        }))
    });
};
export const getPublicNewsSources = async (_req, res) => {
...
export const getPublicNewsSettings = async (_req, res) => {
    const settings = await getNewsSettings();
    return sendSuccess(res, {
...
export const trackPublicNewsShare = async (req, res) => {
