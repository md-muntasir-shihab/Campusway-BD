...
- **[microsoft/agents-v2-py](https://github.com/microsoft/skills/tree/main/.github/plugins/azure-sdk-python/skills/agents-v2-py)** - Foundry Agents SDK â€” container-based agents with custom images
...
- **[fal-ai-community/fal-kling-o3](https://github.com/fal-ai-community/skills/blob/main/skills/claude.ai/fal-kling-o3/SKILL.md)** - Generate images and videos with Kling O3 â€” Kling's most powerful model family
...
- **[fal-ai-community/fal-restore](https://github.com/fal-ai-community/skills/blob/main/skills/claude.ai/fal-restore/SKILL.md)** - Restore and fix image quality â€” deblur, denoise, fix faces, restore documents
...
- **[fal-ai-community/fal-tryon](https://github.com/fal-ai-community/skills/blob/main/skills/claude.ai/fal-tryon/SKILL.md)** - Virtual try-on â€” see how clothes look on a person
...
- **[fal-ai-community/fal-video-edit](https://github.com/fal-ai-community/skills/blob/main/skills/claude.ai/fal-video-edit/SKILL.md)** - Edit existing videos using AI â€” remix style, upscale, remove background, add audio
- **[fal-ai-community/fal-vision](https://github.com/fal-ai-community/skills/blob/main/skills/claude.ai/fal-vision/SKILL.md)** - Analyze images â€” segment objects, detect, OCR, describe, visual Q&A
...
- **[openai/figma-use](https://github.com/openai/skills/tree/main/skills/.curated/figma-use)** - Prerequisite skill for every use_figma tool call â€” write/read actions in Figma context
...
- **[deanpeters/altitude-horizon-framework](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/altitude-horizon-framework)** - Navigate the PMâ†’Director mindset shift covering scope, time horizons, and failure modes
...
- **[deanpeters/director-readiness-advisor](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/director-readiness-advisor)** - Coach the PMâ†’Director transition across four key situations
...
- **[deanpeters/vp-cpo-readiness-advisor](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/vp-cpo-readiness-advisor)** - Coach the Directorâ†’VP/CPO transition including a CEO interview framework
...
- **[deanpeters/discovery-process](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/discovery-process)** - Full discovery cycle: frame problem â†’ research â†’ synthesize â†’ validate (3-4 weeks)
...
- **[deanpeters/prd-development](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/prd-development)** - Structured PRD process: problem â†’ personas â†’ solution â†’ metrics â†’ stories (2-4 days)
- **[deanpeters/product-strategy-session](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/product-strategy-session)** - Full strategy session: positioning â†’ framing â†’ exploration â†’ roadmap (2-4 weeks)
- **[deanpeters/roadmap-planning](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/roadmap-planning)** - Strategic roadmap process: inputs â†’ epics â†’ prioritize â†’ sequence â†’ communicate (1-2 weeks)
- **[deanpeters/skill-authoring-workflow](https://github.com/deanpeters/Product-Manager-Skills/tree/main/skills/skill-authoring-workflow)** - Meta workflow for authoring skills: choose path â†’ validate â†’ update docs â†’ package
...
- **[phuryn/prioritize-assumptions](https://github.com/phuryn/pm-skills/tree/main/pm-product-discovery/skills/prioritize-assumptions)** - Prioritize assumptions with Impact Ã— Risk matrix and experiments
...
- **[garrytan/autoplan](https://github.com/garrytan/gstack/tree/main/autoplan)** - One command, fully reviewed plan: runs CEO â†’ design â†’ eng review automatically
...
- **[muthuishere/hand-drawn-diagrams](https://github.com/muthuishere/hand-drawn-diagrams)** - Generate hand-drawn Excalidraw diagrams from a prompt â€” animated SVG, hosted edit link, and PNG export. Works with Claude Code, Codex, Gemini CLI, and any agent supporting standard skill paths
...
- **[k-kolomeitsev/data-structure-protocol](https://github.com/k-kolomeitsev/data-structure-protocol)** - Graph-based long-term memory skill for AI (LLM) coding agents â€” faster context, fewer tokens, safer refactors
...
- **[more-io/apple-bridges](https://github.com/more-io/claude-apple-bridges)** - Native macOS app access â€” manage Apple Reminders, Calendar, Contacts, Notes, Mail, and tmux sessions via Swift CLI bridges
